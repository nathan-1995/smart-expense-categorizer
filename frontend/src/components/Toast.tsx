...
const Toast = ({ id, type, title, message, duration = 5000, onClose }: ToastProps) => {
  ...
  return (
    <div
      className={`
        fixed top-4 right-4 max-w-sm w-full rounded-lg p-4 shadow-lg z-50
    ...
    >
      <div className="flex items-start">
        ...
        <div className="ml-4 flex-shrink-0 flex">
          <button
            onClick={handleClose}
            className="inline-flex text-gray-400 hover:text-white focus:outline-none focus:text-white transition-colors duration-200"
          >
